...
import {
  ...
  FEATURE_ENABLE_SUBSIDY_REQUESTS,
} from './constants';
...
const features = {
  ...
  ENABLE_SUBSIDY_REQUESTS: (
    process.env.FEATURE_ENABLE_SUBSIDY_REQUESTS || hasFeatureFlagEnabled(FEATURE_ENABLE_SUBSIDY_REQUESTS)
  ),
