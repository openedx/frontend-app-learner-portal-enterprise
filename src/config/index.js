...
import {
  ...
  FEATURE_ENABLE_RECOMMENDATIONS_CAROUSEL,
...
export const features = {
  ...
  ENABLE_RECOMMENDATIONS_CAROUSEL: process.env.FEATURE_ENABLE_RECOMMENDATIONS_CAROUSEL
    || hasFeatureFlagEnabled(FEATURE_ENABLE_RECOMMENDATIONS_CAROUSEL),
