...
import {
  ...
  FEATURE_ENABLE_PROGRAM_PROGRESS_PAGE,
...
const features = {
  ...
  ENABLE_PROGRAM_PROGRESS_PAGE: process.env.FEATURE_ENABLE_PROGRAM_PROGRESS_PAGE
      || hasFeatureFlagEnabled(FEATURE_ENABLE_PROGRAM_PROGRESS_PAGE),
