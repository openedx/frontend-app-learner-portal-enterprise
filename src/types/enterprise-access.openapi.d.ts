...
export interface components {
  schemas: {
     ...
     * @enum {string}
     */
    ActionTypeD5aEnum: "learner_linked" | "notified" | "reminded" | "redeemed" | "cancelled" | "cancelled_acknowledged" | "cancel_email_failed" | "expired" | "expired_acknowledged" | "reversed" | "allocated" | "reallocated" | "approved" | "errored";
    ...
    LearnerContentAssignmentAction: {
       ...
       * * `errored` - Assignment encountered an error
       */
      action_type: components["schemas"]["ActionTypeD5aEnum"];
      /**
       * Format: date-time
