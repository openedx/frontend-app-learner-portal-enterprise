...
export const COVERED_BY_ENTERPRISE_OFFER_MESSAGE = 'The price of this course could be covered with your organization\'s learning credit balance';
      ...
      <>
        ...
        {hasOfferWithInsufficientBalance && (
          <small data-testid="insufficient-offer-balance-text">
            Your organization doesn&apos;t have sufficient balance to cover this course.{' '}
            {<ContactAdmin>Contact your administrator</ContactAdmin>} to learn more
          </small>
        )}
      </>
    );
