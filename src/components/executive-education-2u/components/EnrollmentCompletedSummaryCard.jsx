import { Card, Col, Row } from '@edx/paragon';
        ...
        <Col xs={12} md={9}>
          <Card.Section>
            ...
            <div className="mb-3.5">
              ...
              <div className="small mb-2 text-gray-500">
                Read GetSmarter&apos;s <a className="text-underline" href={config.GETSMARTER_STUDENT_TC_URL} target="_blank" rel="noreferrer">Terms and Conditions</a> for the full course postponement and cancellation policy.
              </div>
            </div>
          </Card.Section>
        </Col>
