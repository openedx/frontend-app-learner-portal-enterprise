...
import { useBrowseAndRequest, useCouponCodes, useEnterpriseCustomer, useSubscriptions } from '../app/data';
...
const ProgramProgressCourses = ({ courseData }) => {
  ...
  const getCertificatePrice = (course) => {
    return <h1>CERTIFICATE PRICE</h1>
  ...
  const renderCertificatePriceMessage = (course) => (
    <h1>CERTIFICATE PRICE MESSAGE</h1>
    // <>
