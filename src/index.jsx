  ...
  handlers: {
    config: () => {
      mergeConfig({
        ...
        FEATURE_ENABLE_BFF_API_FOR_ENTERPRISE_CUSTOMERS: ['d0224477-4903-404a-b3c4-9edfce728d37'] || null,
        // FEATURE_ENABLE_BFF_API_FOR_ENTERPRISE_CUSTOMERS: process.env.FEATURE_ENABLE_BFF_API_FOR_ENTERPRISE_CUSTOMERS || null,
